...
<figure>
  <img
    ...
    alt="Map-style overview of major urban tree conflict zones across India."
  />
  <figcaption>India-wide tree conflict hotspots show this is systemic, not isolated.</figcaption>
</figure>
...
<figure>
  <img
    ...
    alt="Treeless heat corridor contrasted with a shaded avenue lined with mature trees."
  />
  <figcaption>Heat corridor versus shaded avenue: canopy is urban cooling infrastructure.</figcaption>
</figure>

## The legal loophole: when shrubs are made to look like trees
...
### Native canopy-first alternatives that cross legal thresholds faster
...
<figure>
  <img
    ...
    alt="Compact Miyawaki pocket forest in an urban area with layered native plantation."
  />
  <figcaption>Miyawaki helps in small patches, but it cannot replace old canopy trees.</figcaption>
</figure>
