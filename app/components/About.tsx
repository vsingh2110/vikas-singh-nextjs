    ...
    return (
        <section id="about" className="py-16 md:py-20 lg:py-24 bg-white dark:bg-gray-900">
            <div className="max-w-7xl lg:max-w-[1280px] xl:max-w-[1480px] 2xl:max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-20">
                <h2 className="text-center text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-medium font-heading mb-12 md:mb-16 relative pb-5 text-gray-900 dark:text-white">
                    About me
                    ...
                    <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-brand-crimson bg-white dark:bg-gray-900 px-2">
                        who i am
                    </span>
                </h2>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16 xl:gap-20 2xl:gap-24">
                    ...
                    <div className="lg:w-1/2">
                        <div className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-medium mb-4 lg:mb-6 text-gray-900 dark:text-white">
                            I&apos;m Vikas and I&apos;m a{' '}
                        ...
                        <p className="text-gray-700 dark:text-gray-300 text-base md:text-lg lg:text-[22px] xl:text-[26px] 2xl:text-[30px] leading-relaxed mb-6">
