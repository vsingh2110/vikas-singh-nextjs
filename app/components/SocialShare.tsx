...
export default function SocialShare({ title, url, language }: SocialShareProps) {
  const text = {
    en: 'Share this article',
    hi: 'इस लेख को साझा करें'
  }
    ...
    <div className="mt-8 mb-12 py-6 border-t border-b border-gray-200 dark:border-gray-700">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          onClick={async () => {
            if (navigator.share) {
              ...
              alert(language === 'en' ? 'Share not supported on this device' : 'इस डिवाइस पर साझा करना समर्थित नहीं है')
            }
          }}
          className="inline-flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-800 text-white rounded-lg transition-colors text-sm"
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366] hover:bg-[#20BD5A] text-white rounded-lg transition-colors text-sm"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 bg-black hover:bg-gray-800 text-white rounded-lg transition-colors text-sm"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 bg-[#0A66C2] hover:bg-[#004182] text-white rounded-lg transition-colors text-sm"
        ...
        {/* Email */}
        <a
          href={`mailto:?subject=${encodedTitle}&body=${shareText}%20${encodedUrl}`}
