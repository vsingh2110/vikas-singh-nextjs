export default function Services() {
  ...
  return (
    <section id="services" className="py-16 md:py-20 lg:py-24 bg-white dark:bg-gray-800">
      <div className="max-w-[1300px] lg:max-w-[1400px] xl:max-w-[1600px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-24 2xl:px-28">
        <h2 className="text-center text-3xl sm:text-4xl md:text-5xl font-medium font-ubuntu mb-12 md:mb-16 relative pb-5 dark:text-white">
          ...
          <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 text-base sm:text-lg md:text-xl text-[#dc143c] bg-white dark:bg-gray-800 px-2">
            what i provide
          </span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 xl:gap-10 2xl:gap-12">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-gray-50 dark:bg-gray-700 rounded-md p-8 md:p-10 lg:p-10 xl:p-14 2xl:p-16 text-center cursor-pointer transition-all duration-300 hover:bg-[#dc143c] hover:scale-105 group border border-gray-200 dark:border-gray-600"
            >
              ...
              <h3 className="text-xl sm:text-2xl lg:text-[19px] xl:text-3xl 2xl:text-4xl font-medium mb-3 sm:mb-4 text-gray-800 dark:text-white group-hover:text-white transition-colors duration-300">{service.title}</h3>
              <p className="text-sm sm:text-base lg:text-[13px] xl:text-lg 2xl:text-xl text-gray-700 dark:text-gray-300 group-hover:text-white transition-colors duration-300">{service.description}</p>
            </div>
          ))}
        </div>
      </div>
