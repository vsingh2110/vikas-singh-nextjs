    ...
    >
      ...
      <div className="max-w-[1300px] lg:max-w-[1400px] xl:max-w-[1600px] 2xl:max-w-[1800px] w-full mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-24 2xl:px-28 relative z-10">
        <div className="text-white font-ubuntu">
          <div className="text-xl sm:text-2xl md:text-3xl lg:text-[22px] xl:text-[38px] 2xl:text-[44px] leading-tight">
            Hello, my name is
          </div>
          <div className="text-5xl sm:text-6xl md:text-7xl lg:text-[60px] xl:text-[100px] 2xl:text-[120px] font-semibold -ml-1 leading-tight mt-2">
            Vikas Singh
          </div>
          <div className="text-2xl sm:text-3xl md:text-4xl lg:text-[34px] xl:text-[56px] 2xl:text-[64px] my-4 sm:my-5 lg:leading-[1.4] xl:leading-[1.3] 2xl:leading-[1.3] min-h-[70px] sm:min-h-[90px] lg:min-h-[100px] xl:min-h-[140px] 2xl:min-h-[160px]">
            And I&apos;m a{' '}
          ...
          <a
            href="/blog"
            className="inline-block bg-[#dc143c] text-white text-base sm:text-lg md:text-xl lg:text-[20px] xl:text-[32px] 2xl:text-[36px] px-6 sm:px-7 md:px-8 lg:px-8 xl:px-12 2xl:px-14 py-2 sm:py-2.5 md:py-3 lg:py-3 xl:py-5 mt-4 sm:mt-5 rounded-md border-2 border-[#dc143c] hover:bg-transparent hover:text-[#dc143c] transition-all duration-300"
          >
            Read My Blogs
          </a>
        </div>
