  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white pt-20 sm:pt-24 pb-12 sm:pb-16">
        ...
        <div className="w-full max-w-[1920px] mx-auto px-16 mb-4 pt-1.5 sm:pt-0 flex items-center justify-between gap-4 flex-wrap">
          <Link
            href={`/blog/${lang}`}
        ...
        <article className="w-full max-w-[1920px] mx-auto px-16">
          {/* Breadcrumb */}
